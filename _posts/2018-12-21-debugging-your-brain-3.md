---
layout: post
title: Debugging Your Brain Part 3, Emotions
tagline: Cognitive Restructuring for Systems Thinkers
tags:
---

# Processing Emotion
To get better at processing your emotions, I have six concrete techniques for you!
...
In the section after this one, we’ll cover how to influence your emotions using your thoughts.

### Emotions as Inputs
Before we jump into these six, I’ll explain a principle that applies to each of these: accepting “emotions as inputs”.

In the moment where you experience an emotion, it’s already outside of your control and influence. In the system we described earlier (input, process, output), “you” are your conscious mind, and these “automatic emotions” are an input to your system. It helps to accept automatic emotions as data for your mind to process. This takes a lot of practice and training. Many meditation practices focus on this skill - observing thoughts and emotions non-judgmentally.

If you can accept automatic emotions as inputs to your system, you will better be able to [xyz].

[You can get value out of this]
Feeling settled
Able to express these emotions to yourself and to others

Processing emotions helps you choose the best response for a situation. You can also influence your future feelings through the thoughts you choose to think.
Six Emotion Processing Techniques


## Talk with a friend

My top favorite way to process emotions (and thoughts) is by talking through them with a close friend. You could both feel better, and understand yourself better. Friends can validate your experiences by reflecting back to you what they think you’re thinking/feeling. If you end up with a shared understanding of your experience, that can be very comforting. They can summarize with different words and phrasing than you have, which can also improve how you understand yourself.
...
There is a recent “loneliness epidemic” in the US. [source](https://www.cigna.com/newsroom/news-releases/2018/new-cigna-study-reveals-loneliness-at-epidemic-levels-in-america). If you don't feel like you have many (or any?) close friends you can have intimate discussions with, you may want to make deepening relationships a priority. This can be really difficult, but it’s well worth the effort.
...
The ability to describe our emotions using words is extremely powerful. It’s much easier to think about these feelings when we have words to describe them. Words give the emotions “handles” that we can use to inspect them and figure out what they really are. This helps both for conveying our emotions to other people. This even helps us work with the emotions inside our own minds.

Expanding your emotional vocabulary can help a lot. Children are usually taught simple emotions first - like happy, sad, angry, tired. Many people continue to rely on a relatively small set of emotion-words even in adulthood. With effort, you can learn to use a much richer vocabulary.

You already distinguish between many types of happy when other people use the words - such as excited, relieved, content, proud, or accomplished. The next step is to start using richer words yourself, too. The more you use these, the more quickly and readily you will be able to use them to describe yourself. The more you practice, the more you’ll start using these naturally.

One way to expand your emotional vocabulary is by keeping a thesaurus-like chart like this around. Print this one out, or save it to your desktop. Refer to it when trying to describe your emotions. There are many more resources like this online - some in circular graphs, some with more colors. You might also try a traditional thesaurus, especially when you have a specific feeling you can’t quite describe.

I often work on expanding my emotional vocabulary a lot while talking with friends. Sometimes I ramble a bit first, trying to figure out the right word, and my friends help. For example, I might try: “I feel good about it. Excited maybe? Not quite excited, but I think it’ll go my way, and that’s comforting” and in response, my friend might suggest “are you feeling confident?”. Often we can find a single word. If not, we can at least find a phrase or sentence-long explanation of the feeling. Once we have a shared understanding, that really validates my experience. This shared understanding helps me feel like the emotion has been processed. I feel relief.

## Rubber duck

The “rubber duck” technique is a common trick among software developers. In the programming context it is called “rubber duck debugging”. Just by explaining the situation to the duck, you may gain insight into the problem. You can imagine the responses and questions a person would have if you were explaining this to them. You can imagine the duck as your coworker, friend, partner, or anyone. The imagined-person might help you realize an assumption you’re making that might be wrong, or they might help you notice something you overlooked before. If the duck doesn’t help enough, you can always fall back to asking a coworker or friend for help.

I often use a written variant of this. I start by draft an email or instant message to a coworker explaining the situation. Before I send it, I make it as thorough as I imagine they’d want. I answer the questions I know they’d ask. Often, I end up not needing to send the email at all! The questions I imagined they would ask me help a lot. Even though I use this technique a lot, I still feel surprised every time just how effective it is.

I’m using work examples here, but the same idea applies to personal experiences you have, too. You can change the imagined-audience to be your best friend or someone else appropriate. If there’s nobody appropriate, you might try making up someone who is magically wise about this situation.

## Journaling

You don't even have to have another person as your audience when talking/writing. Journaling could be writing to yourself, future-you, past-you, or even to the journal itself. Journaling is a really useful tool to have in your emotional toolbelt.
